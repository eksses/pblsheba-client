...
const resources = {
  en: {
    translation: {
      ...
      "dob": "Date of Birth",
      "age": "Age",
      "contact_financial": "Contact & Financial",
      "bank_account_any": "Bank Account (if any)",
      "bank_name": "Bank Name",
      "branch": "Branch",
  ...
  bn: {
    translation: {
      ...
      "dob": "জন্ম তারিখ",
      "age": "বয়স",
      "contact_financial": "যোগাযোগ ও আর্থিক তথ্য",
      "bank_account_any": "ব্যাংক অ্যাকাউন্ট (যদি থাকে)",
